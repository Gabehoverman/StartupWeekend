...
using Startup_Weekend_Application.Models.AccountViewModels;
using Startup_Weekend_Application.Services;
...
namespace Startup_Weekend_Application.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = "/dashboard")
        {
            ViewData["ReturnUrl"] = returnUrl;
